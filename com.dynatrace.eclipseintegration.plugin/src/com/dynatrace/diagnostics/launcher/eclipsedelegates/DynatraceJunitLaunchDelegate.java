...
public class DynatraceJunitLaunchDelegate extends JUnitLaunchConfigurationDelegate {
	...
	public synchronized void launch(ILaunchConfiguration configuration, String mode, ILaunch launch, IProgressMonitor monitor)
		...
		ILaunchConfiguration configToUse = Activator.getDefault().getLauncherCallbacks().onNewLaunch(DynatraceJunitLaunchDelegate.class, configuration,
				launch);
